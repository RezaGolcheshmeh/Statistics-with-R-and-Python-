...
**Measures of Central Tendency** are statistical values that represent the *center* or *typical value* of a data set.
They help us understand the overall trend or “average” behavior of the data.
